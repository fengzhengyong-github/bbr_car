...
def generate_launch_description():
    # 获取默认路径
    robot_name_in_model = "bbr_robot"
    urdf_tutorial_path = get_package_share_directory('bbr_robot_description')
    default_model_path = urdf_tutorial_path + '/urdf/bbr_robot.xacro'
    default_rviz_config_path = urdf_tutorial_path + '/config/rviz/gazebo_launch.rviz'
